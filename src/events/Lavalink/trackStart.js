...
module.exports = async (client, player, track, payload) => {
  ...
  const thing = new MessageEmbed()
    ...
    .setImage(track.displayThumbnail("3"))
    .setColor(client.embedColor)
    .setTimestamp()
   const But1 = new MessageButton().setCustomId("vdown").setEmoji("🔉").setStyle("DANGER");
   ...
   const But5 = new MessageButton().setCustomId("vup").setEmoji("🔊").setStyle("SUCCESS");
